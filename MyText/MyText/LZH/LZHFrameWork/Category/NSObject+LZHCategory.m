//
//  NSObject+LZHCategory.m
//  IMIXPARK
//
//  Created by issuser on 15/12/25.
//  Copyright © 2015年 刘志豪. All rights reserved.
//
...
@implementation NSObject (LZHCategory)
-(void)setObj:(id)obj{
    objc_setAssociatedObject(self, object, obj, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
-(id)obj{
